...
export class PartnerH5Service {
  ...
  async prepay(request: PartnerH5PrepayRequest): Promise<PartnerH5PrepayResponse> {
    ...
    const response = await this.httpClient.post<PartnerH5PrepayResponse>(url, request, headers);
 ...
 * @public
 */
export interface PartnerH5PrepayRequest extends PartnerPrepayRequest {
  /**
   * H5 场景信息
   */
  h5_info: {
 ...
 * @public
 */
export interface PartnerH5PrepayResponse {
  /**
   * H5 URL
   */
  h5_url: string;
